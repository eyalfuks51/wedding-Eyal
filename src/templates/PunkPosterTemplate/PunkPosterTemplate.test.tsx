...
import PunkPosterTemplate from './PunkPosterTemplate';
...
const event = { id: 'evt-1', slug: 'test', template_id: 'punk-poster' };

describe('PunkPosterTemplate contract', () => {
  it('renders with empty config without throwing', () => {
    const html = renderToStaticMarkup(
      createElement(PunkPosterTemplate, { event, config: {} })
    );
    expect(html).toContain('pk__hero');
  });
