...
const event = { id: 'evt-1', slug: 'test', template_id: 'constructivist' };

describe('ConstructivistTemplate contract', () => {
  it('renders with empty config without throwing', () => {
    const html = renderToStaticMarkup(
      createElement(ConstructivistTemplate, { event, config: {} })
    );
    expect(html).toContain('ct__hero');
  });
